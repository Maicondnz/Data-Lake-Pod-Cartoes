...
def _start_emr_cluster(**kwargs):
    ...
    response = emr_client.run_job_flow(
        Name=f'01_process_{SUBJECT}_credit',
...
def _add_step_job(**kwargs):
    ...
    script_path = f's3://maicon-donza-lake-586794485137/04_codes/process_book_credit.py'

    response = emr_client.add_job_flow_steps(
        JobFlowId=cluster_id,
        Steps=[
            {
                'Name': f'process_{SUBJECT}_credit',
